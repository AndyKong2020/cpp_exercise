...
//构造函数
Sentry::Sentry(Team team_, unsigned short index_)
{
this->team_ = team_;
this->index_ = index_;
}
...
void Sentry::Print()
{
    cout << " team_" << team_ << " type_sentry" << " index_" << index_ << " health_point_" << health_point_ << " heat_point_" << heat_point << endl;
}